...
% Вариант установки шрифта Times New Roman для компилятора XeLaTeX
\input{fonts_xelatex}%
...
\setlength{\parindent}{1.25cm} % Примерно соответсвует 5 символам.


% Зачем: Настраивает отступы от границ страницы.
% Почему: Пункт 2.1.2 Требований по оформлению пояснительной записки.
\usepackage[left=3cm,top=2.0cm,right=1.5cm,bottom=2cm]{geometry}
...
\fancyfoot[R]{\rmfamily\thepage} % установка верхнего колонтитула
...
% Зачем: Устанавливает симвоЬЕ,ЕГО СВОЙСТВА И ПРИЛОЖЕНИЯ»л начала простого перечисления
